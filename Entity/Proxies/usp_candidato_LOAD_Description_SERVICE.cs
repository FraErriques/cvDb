...
namespace Entity.Proxies
{
    ...
    public abstract class usp_candidato_LOAD_Description_SERVICE
    {


        public static System.Data.DataTable usp_candidato_LOAD_Description(
			Int32 id		//
		)
		{
            //
            ...
            cmd.CommandText = "usp_candidato_LOAD_Description";
            //
            ...
            catch (Exception ex)
            {
                ...
                LoggingToolsContainerNamespace.LoggingToolsContainer.DecideAndLog(
					ex,
					"eccezione in DataAccess::usp_candidato_LOAD_Description_SERVICE : " + ex.Message,
                    0 // verbosity
                );
                //
            }// end catch
