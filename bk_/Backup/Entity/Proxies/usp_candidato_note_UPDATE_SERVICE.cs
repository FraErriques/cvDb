...
namespace Entity.Proxies
{
    ...
    public abstract class usp_candidato_note_UPDATE_SERVICE
    {


        public static int usp_candidato_note_UPDATE(
			Int32 id,
			string note,
		...
		)
		{
            ...
            cmd.CommandText = "usp_candidato_note_UPDATE";
            //
            ...
            catch (Exception ex)
            {
                ...
                writingSucceeded =
                    LoggingToolsContainerNamespace.LoggingToolsContainer.DecideAndLog(
                        ex,
                        "eccezione in DataAccess::usp_candidato_note_UPDATE_SERVICE : " + ex.Message,
						0 // verbosity
                );
                //
            }// end catch
