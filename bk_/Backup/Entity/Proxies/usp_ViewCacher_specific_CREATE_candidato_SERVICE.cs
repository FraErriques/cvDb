...
namespace Entity.Proxies
{
    ...
    public abstract class usp_ViewCacher_specific_CREATE_candidato_SERVICE
    {


        public static int usp_ViewCacher_specific_CREATE_candidato(
			string where_tail,
		...
		)
		{
            ...
            cmd.CommandText = "usp_ViewCacher_specific_CREATE_candidato";
            //
            ...
            catch (Exception ex)
            {
                ...
                writingSucceeded =
                    LoggingToolsContainerNamespace.LoggingToolsContainer.DecideAndLog(
                        ex,
                        "eccezione in DataAccess::usp_ViewCacher_specific_CREATE_candidato_SERVICE : " + ex.Message,
						0 // verbosity
                );
                //
            }// end catch
