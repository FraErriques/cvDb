...
namespace Entity.Proxies
{
    ...
    public abstract class usp_utente_LOADDECODEDSINGLE_SERVICE
    {


        public static System.Data.DataTable usp_utente_LOADDECODEDSINGLE(
			Int32 id		//
		)
		{
            //
            ...
            cmd.CommandText = "usp_utente_LOADDECODEDSINGLE";
            //
            ...
            catch (Exception ex)
            {
                ...
                LoggingToolsContainerNamespace.LoggingToolsContainer.DecideAndLog(
					ex,
					"eccezione in DataAccess::usp_utente_LOADDECODEDSINGLE_SERVICE : " + ex.Message,
                    0 // verbosity
                );
                //
            }// end catch
