...
namespace Entity.Proxies
{
    ...
    public abstract class usp_lCrash_LOADSINGLE_SERVICE
    {


        public static System.Data.DataTable usp_lCrash_LOADSINGLE(
			Int32 id		//
		)
		{
            //
            ...
            cmd.CommandText = "usp_lCrash_LOADSINGLE";
            //
            ...
            catch (Exception ex)
            {
                ...
                LoggingToolsContainerNamespace.LoggingToolsContainer.DecideAndLog(
					ex,
					"eccezione in DataAccess::usp_lCrash_LOADSINGLE_SERVICE : " + ex.Message,
                    0 // verbosity
                );
                //
            }// end catch
