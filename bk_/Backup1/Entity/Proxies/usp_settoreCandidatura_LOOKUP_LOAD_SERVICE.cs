...
namespace Entity.Proxies
{
    ...
    public abstract class usp_settoreCandidatura_LOOKUP_LOAD_SERVICE
    {


        public static System.Data.DataTable usp_settoreCandidatura_LOOKUP_LOAD(
		//
		)
		{
            //
            ...
            cmd.CommandText = "usp_settoreCandidatura_LOOKUP_LOAD";
            //
            ...
            catch (Exception ex)
            {
                ...
                LoggingToolsContainerNamespace.LoggingToolsContainer.DecideAndLog(
					ex,
					"eccezione in DataAccess::usp_settoreCandidatura_LOOKUP_LOAD_SERVICE : " + ex.Message,
                    0 // verbosity
                );
                //
            }// end catch
